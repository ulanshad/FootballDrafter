<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Drafter.aspx.cs" Inherits="FootballDrafter.Drafter" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <p class="style1">
            <strong>Select Player:</strong> (<a href="DrafterFA.aspx">Include FA</a>)</p>
            ...
            <tr>
                <td>
                    ...
                    <asp:SqlDataSource ID="QBsDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:FantasyFootballConnectionString %>"
                        SelectCommand="SELECT [playerId], [playerName] FROM [players] WHERE ([positionId] = @positionId AND [teamId] <> 0) ORDER BY [playerName]">
                        <SelectParameters>
