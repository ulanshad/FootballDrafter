<%@ Page Title="" Language="C#" MasterPageFile="~/Wide.Master" AutoEventWireup="true"
    CodeBehind="ResultsTeam.aspx.cs" Inherits="FootballDrafter.ResultsTeam" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <p class="style1">
        <strong>Results By Team</strong> (<a href="ResultsRound.aspx">Round</a>) - <a href="DraftedTeam.aspx">Full</a></p>
    <table width="100%">
        <tr>
            <td>
                <p>
                    <strong>Rose/Odrabina</strong></p>
